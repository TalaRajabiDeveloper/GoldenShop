...
export class Pagination implements OnInit, IPaginationConfig, IAttribute {
    ...
    constructor(@Self() public cd:any, public renderer:Renderer, public elementRef:ElementRef) {
